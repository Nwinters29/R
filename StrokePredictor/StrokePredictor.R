...
filePath <- "/Users/nickwinters/desktop/DS Projects/R/strokePredictor"
...
# assign only the relavent features to a new variable
clean_strk <- strk |> 
  select(age_group, 
         bmi_group,
         glucose_group,
...
# create new csv file of the cleaned data
# write_csv(clean_strk, file = "/Users/nickwinters/desktop/DS Projects/R/strokePredictor/cleanData.csv") # uncomment to create new csv
...
## Finalized Workflow
rf_workflow_tuned <- finalize_workflow(rf_workflow, param_final)
rf_workflow_tuned
...
#saveRDS(final_model, file = "/Users/nickwinters/desktop/DS Projects/R/strokePredictor/model.rds") # uncomment to save model
